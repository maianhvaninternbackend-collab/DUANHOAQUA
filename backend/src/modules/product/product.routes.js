...
route.get("/me/top-new", productUsercontroller.getTopNewProducts);
route.get("/me/:slug", productUsercontroller.getProductBySlug);
...
route.post("/create", upload.array("images", 10), productAdmincontroller.createProduct);
