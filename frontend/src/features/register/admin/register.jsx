...
import { registerAdminApi } from "../../../api/auth.api";
import "./register.css";
...
const RegisterAdmin = () => {
    ...
    const validate = () => {
        ...
        if (!formValues.fullName) newErrors.fullName = "Full name required";
        ...
        <div className="admin-register-container">
            ...
            <div className="admin-register-card">
                ...
                <form className="admin-register-form" onSubmit={handleSubmit}>
                    ...
                    {errors.fullName && <p className="admin-error">{errors.fullName}</p>}
